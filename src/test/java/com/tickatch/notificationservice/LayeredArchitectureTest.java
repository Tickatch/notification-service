...
@AnalyzeClasses(
    packages = "com.tickatch.notificationservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.tickatch.notificationservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.tickatch.notificationservice..presentation..")
        .layer("Application")
        .definedBy("com.tickatch.notificationservice..application..")
        .layer("Domain")
        .definedBy("com.tickatch.notificationservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.tickatch.notificationservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.tickatch.notificationservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.tickatch.notificationservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.tickatch.notificationservice.global..")
        .should()
        .dependOnClassesThat()
